...
pub const WORDS: &'static [&'static str] = &[
	...
	"惊天地泣鬼神,Jīng,tiā,ndì,qì,guǐ,shén",
	...
	"看不起,kàn,bù,qǐ",
	"看不清,kàn,bù,qīng",
	"看不上,kàn,bù,shàng,kàn,bù,shàng,yǎn",
	"看财奴,kàn,cái,nú",
	...
	"难上难,nán,shàng,nán,nán,shàng,jiā,nán",
	...
	"宁死不屈,nìng,sǐ,bù,qū",
	"宁死不辱,níng,sǐ,bù,rǔ",
	"宁为玉碎不为瓦全,nìng,wéi,yù,suì，bù,wéi,wǎ,quán",
	"宁馨儿,níng,xīn,ér",
	...
	"悬龟系鱼,xuán,guī[uni]58566[/uni]jì,yú",
